 ...
 * @version 1.0 3/12/12
 */
@Document(collection = "wishCategories")
public class WishCategory extends BaseModel implements Entity
{
    public WishCategory()
    {
    }

    public WishCategory(Long id, String name, String description, Picture picture)
    {
