...
{
    public void publishWishModification(Long memberId, Long wishId, GenericData newValues);

    public void publishWishCategoryModification(Long memberId, Long categoryId, GenericData newValues);
